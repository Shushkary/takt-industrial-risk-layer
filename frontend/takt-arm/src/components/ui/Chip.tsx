...
export function Chip({
  ...
  return (
    <button
      type="button"
      className={`rounded-takt border px-2 py-0.5 text-[12px] transition-colors duration-150 ease-[cubic-bezier(0.2,0,0,1)] takt-focus-ring disabled:pointer-events-none disabled:opacity-40 ${
        active
