# ТАКТ — АРМ оператора (вспомогательный)

> **Вспомогательный интерфейс, не для демонстрации жюри.** Канонический АРМ заявки
> «Техлаб 2026» — [`frontend/takt-pt-arm`](../takt-pt-arm) (решение от 2026-08-03).
> Этот React-вариант остаётся рабочей средой разработки и проверки REST-контура:
> он подключён к API репозитория и несёт собственный релизный гейт.
