...
| Показатель | Значение |
|---|---|
| Кейс INC-002 | 41 событие, класс HIGH, балл 0.536 |
...
| Очередь по классам | 1 высокий, 19 средних, 262 низких |
...
Класс `HIGH` при балле 0.536 — следствие пересчёта порогов на достижимый максимум шкалы
0.800 (`high: 0.52`, `critical: 0.68`): вес вектора качества данных при полных данных не
участвует, и прежние пороги, назначенные от единицы, занижали классы. Разбор —
[risk_scale_calibration.md](../risk_scale_calibration.md), раздел «Продолжение 2026-08-24».
